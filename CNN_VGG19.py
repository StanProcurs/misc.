...
train_dir = '/home/students/dipe038-2/stan/data/augmented_dataset'
train_img_list = list()
train_label_list = list()
emotions = ['Angry', 'Disgust', 'Fear', 'Happy', 'Neutrals', 'Sad', 'Surprise']
...
valid_dir = '/home/students/dipe038-2/stan/data/val'
valid_img_list = list()
